...
./post-installation.sh clock yay terminal shortcuts shell autorandr albert slock slick-greeter vscode fsearch tools gthumb git conky wireshark mpv notifications pcspeaker xfce mongo qemu
```
